# -*- coding: utf-8 -*-
"""
Trains a Bidirectional LSTM model for emotion classification on Indonesian tweets.
...
MODEL_SAVE_PATH = 'lstm_emotion_model.pth'
...
def main():
    ...
    X_train_texts, X_temp, y_train, y_temp = train_test_split(df['cleaned_tokens'], labels, test_size=0.3, random_state=42, stratify=labels)
    ...
    X_val_seq = texts_to_sequences(X_val, word_to_idx)
